    ...
    public class BooksController : ODataController
    {
        private IList<Book> _books = new List<Book>
        {
            ...
            new Book
            {
                ...
                DynamicProperties=new Dictionary<string,DynamicProperties>
                {
                    {"DynamicProperties",new DynamicProperties
                        { KeyValues=new Dictionary<string, object>
                            {
                            { "DynamicProperties-Published", new DateTimeOffset(2014, 7, 3, 0, 0, 0, 0, new TimeSpan(0))},
                            { "DynamicProperties-Authors", new [] { "Leonard G. Lobel", "Eric D. Boyd" }},
                            { "DynamicProperties-OtherCategories", new [] {Category.Book, Category.Magazine}}
                            }
                        }
                    }
